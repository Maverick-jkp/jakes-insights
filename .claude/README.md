...
│   └── DEV_TESTING.md          # Testing Specialist
├── workflows/                   # 워크플로우 가이드
...
2. **전문화된 에이전트**: 각 에이전트는 명확한 역할과 책임
...
### 🧪 DEV_TESTING (Testing Specialist)
- **역할**: 테스트 작성 및 품질 보증
...
### 에이전트 가이드
- [MASTER.md](agents/MASTER.md): Master Agent 전체 가이드
- [CTO.md](agents/CTO.md): CTO 역할 및 책임
- [DESIGNER.md](agents/DESIGNER.md): Designer 역할 및 책임
- [DEV_BACKEND.md](agents/DEV_BACKEND.md): Backend Developer 가이드
- [DEV_TESTING.md](agents/DEV_TESTING.md): Testing Specialist 가이드
