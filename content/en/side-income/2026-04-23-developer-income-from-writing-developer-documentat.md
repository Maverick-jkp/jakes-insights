...
1. **Document an open-source API that has bad docs.** Pick something real on GitHub. Write a proper reference guide. Host it on a personal site or Notion. This is legitimate portfolio work.
2. **Contribute to an open-source project's docs.** Many projects — check `good first issue` labels on GitHub filtered to "documentation" — actively welcome this. You get a real merged PR to show.
3. **Write one long-form technical tutorial** and publish it on dev.to or your own blog. A detailed, code-heavy tutorial demonstrates your technical writing voice better than anything.
