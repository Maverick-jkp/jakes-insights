...
aliases:
  - "/tech/2026-02-24-postgres-샤딩-앱-코드-수정-없이-가능한가-pgdog-실전-검증/"
  - "/ko/tech/2026-02-24-postgres-샤딩-앱-코드-수정-없이-가능한가-pgdog-실전-검증/"
...
- [클라우드 스토리지 비교: S3 vs Google Cloud Storage vs Azure Blob 비용과 성능 분석](/ko/tech/클라우드-스토리지-비교-s3-vs-google-cloud-storage-vs-azure-b/)
