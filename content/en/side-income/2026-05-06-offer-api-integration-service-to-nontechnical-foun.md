...
1. A Stripe webhook that writes payment data to a Supabase table
2. A Twilio SMS notification triggered by a form submission
3. An OpenAI API call inside a simple Express app with basic error handling
