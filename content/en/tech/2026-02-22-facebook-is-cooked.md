...
author: "Jake Park"
categories: ["tech"]
tags: ["facebook is cooked", "tech", "facebook", "cooked", "React", "GPT", "subtopic:ai"]
...
faq:
  - question: "is facebook is cooked or still worth using in 2025"
    answer: "Facebook still has 3.07 billion monthly active users and generated $164.5 billion in revenue in 2024, so it remains financially dominant. However, the platform's feed is increasingly overrun with AI-generated spam and fake images, while real social connections between friends have become nearly invisible, making the day-to-day experience feel broken despite the strong financial numbers."
  - question: "why is facebook full of AI generated spam and fake images"
    answer: "Meta's 2018 algorithm shift to prioritize 'meaningful social interactions' inadvertently rewarded emotionally manipulative content because it generates high engagement through comments and reactions. Spam operators quickly exploited this by flooding the platform with cheap AI-generated content targeting high-value US users, who are worth roughly $68.44 in ad revenue compared to $5.52 for Asia-Pacific users."
  - question: "what demographic uses facebook the most now"
    answer: "Gen X is now Facebook's largest demographic, as Gen Z has largely abandoned the platform. This represents a serious long-term structural problem for Meta, since a platform that fails to attract younger users faces an inevitable aging-out of its core user base that no engagement metric can permanently disguise."
  - question: "why do people still use facebook if it's so bad"
