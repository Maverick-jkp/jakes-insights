...
aliases:
  - "/tech/2026-03-03-모토로라-grapheneos-협력-프라이버시-안드로이드-실제-의미/"
  - "/ko/tech/2026-03-03-모토로라-grapheneos-협력-프라이버시-안드로이드-실제-의미/"
...
- [모토로라 GrapheneOS 파트너십, 프라이버시 폰 시장에 실제로 의미하는 것](/ko/tech/모토로라-grapheneos-파트너십-프라이버시-폰-실제-의미/)
