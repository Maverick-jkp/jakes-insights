...
author: "Jake Park"
categories: ["tech"]
tags: ["anthropic", "safety", "pledge", "dropped", "subtopic-ai"]
...
image: "/images/20260225-anthropic-safety-pledge-droppe.webp"
technologies: ["AWS", "Claude", "GPT", "OpenAI", "Anthropic"]
faq:
  - question: "what is the Anthropic safety pledge dropped AI race pressure story about"
    answer: "The Anthropic safety pledge dropped AI race pressure story refers to Anthropic quietly revising its Responsible Scaling Policy in February 2026 to include a competitive caveat, allowing the company to accelerate safety timelines when rivals move faster. Bloomberg reported the change, which signals a significant shift from the 'safety-first' positioning that originally defined Anthropic's brand. The move came amid growing pressure from competitors like OpenAI, Google, and xAI capturing market share with fewer safety restrictions."
  - question: "did Anthropic change its responsible scaling policy in 2026"
    answer: "Yes, Anthropic revised its Responsible Scaling Policy (RSP) in February 2026, adding language that allows safety commitments to flex based on what competitors are doing. The original RSP had committed Anthropic to pausing or slowing AI deployments if internal evaluations flagged specific risk thresholds, and was previously cited by EU and UK regulators as a model for voluntary AI safety. The revision effectively weakens those hard commitments by introducing a competitive pressure clause."
  - question: "why did Anthropic drop its AI safety pledge under race pressure from competitors"
    answer: "Anthropic faced mounting commercial pressure after OpenAI's o3, Google's Gemini Ultra 2, and xAI's Grok 3 launched with fewer safety restrictions and captured significant enterprise market share. The Anthropic safety pledge dropped AI race pressure dynamic also included geopolitical factors, with Defense Secretary Pete Hegseth reportedly warning Anthropic to allow unrestricted military use of its AI systems. Together, these forces made Anthropic's strict safety-first positioning increasingly difficult to maintain without losing ground commercially."
  - question: "what does Anthropic's policy change mean for businesses using Claude"
...
2. [Anthropic Adds Caveat to AI Safety Policy in Race Against Rivals - Bloomberg](https://www.bloomberg.com/news/articles/2026-02-25/anthropic-adds-caveat-to-ai-safety-policy-in-race-against-rivals)
3. [AP report: Hegseth warns Anthropic to let the military use company's AI tech as it sees fit | PBS Ne](https://www.pbs.org/newshour/world/ap-report-hegseth-warns-anthropic-to-let-the-military-use-companys-ai-tech-as-it-sees-fit)
